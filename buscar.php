...
<body id="body">
    ...
    <main>
    <h1>Buscar elemento en el inventario</h1><br>
     ...
     <label for="buscar" style="font-size: 18px; margin: 5px 0px;">Escriba el id del bolso</label>
            <input type="number" id = "buscar" name = "idBolso">
            <button type="submit" class="boton1" name="btnBuscar" value="ok">Buscar</button>
     </form>
     ...
     <?php
     include "backend_php/buscarController.php";
     ?>
