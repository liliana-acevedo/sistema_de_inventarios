...
<body id="body">
    ...
    <h1>Modificación </h1><br>
     ...
     <?php
        ...
        include "backend_php/modificarController.php";
        ...
        $result = $conexion-> query($sql);
            ...
            { ?>
                ...
                <label for="id">ID del bolso</label>
                  <input type="text" class="id" id="id" name="idBolso" value ="<?=$mod['idBolso']?>">
                  <br>

                  <label for="cantidad">Cantidad</label>
                    <input type="text" class="cantidad" id="cantidad" name="cantidad" value ="<?=$mod['cantidad']?>">
                <br>

                <label for="estadoBolso">Estado del bolso</label>
                  <select id="estadoBolso" name="estadoBolso" class="estadoBolso">
                ...
                <label for=ubicacion>Ubicacion</label>
                    <input type=text class=ubicacion id=ubicacion name=idAlmacen value ="<?=$mod['idAlmacen']?>">
                        <br>
                <button type='submit' class=boton1 name=btnGuardar value=ok>Guardar cambios</button>
