...
<body id="body">
    ...
    <a href="buscar.php" class="botonFuncion"> 
     ...
     <a href="fpdf_imprimirPDF/PruebaV.php" class="botonFuncion"> 
     <i class="fa-solid fa-file-shield"></i> Generar respaldo </a>
    ...
    <table class ="tabla">
        ...
        <?php
            include "backend_php\botonMostrarInventario.php"
        ?>
        <br>
        <?php
            include "backend_php/eliminarController.php";
        ?>
